package com.example.a7t11sqllite.BaseDatos;
...
public class DatosHelper extends SQLiteOpenHelper {
    ...
    public static String NOMBREDB = "dbAgenda7t11";
    ...
    public static final String CONSULTA_CREAR_TABLA = "create table " + tabladatos.TABLA + "( " + tabladatos.COLUMNA_ID + " integer not null primary key autoincrement," +
            tabladatos.COLUMNA_NOMBRE + "varchar, " + tabladatos.COLUMNA_EDAD + "integer, " + tabladatos.COLUMNA_CORREO + " varchar)";
    ...
    public DatosHelper(Context context){
        super(context,"dbAgenda7t11",null, VERSION_DB);
    }
